            ...
            <div class="form_container">
                <form action="{{ route('inicioSesion') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control input_user" placeholder="E-mail" name="correo" id="correo" required>
                    </div>
                    <div class="input-group mb-3">
                        <input type="password" class="form-control input_pass" placeholder="Contraseña" name="clave" id="clave" required>
                    </div>
                    <div class="input-group mb-3">
